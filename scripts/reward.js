    ...
    <div class="shadow-md w-full mt-2 relative items-center flex rounded-[16px]">
        ...
        <div class="-ml-2 md:ml-0 relative py-10 w-[60%] -mt-10 flex flex-col">
            <div class="p-6">
                ...
                <button class="mt-2 text-white bg-black text-[13px] px-8 py-2 rounded-[8px]">${reward.buttonText}</button>
            </div>
        </div>
        <div class="bg-[#FC3903] absolute bottom-0 md:text-base text-xs w-full font-[600] text-white px-3 py-3 rounded-b-[16px] text-center">
            ${reward.discount}
        </div>
    </div>
    `
...
const renderExpiredRewards = (data) => {
    ...
    <div class="shadow-md w-full mt-2 relative items-center flex rounded-[16px]">
        ...
        <div class="bg-[${reward.discountColor}] absolute bottom-0 md:text-base text-xs w-full font-[600] text-white px-3 py-3 rounded-b-[16px] text-center">
            ${reward.discount}
        </div>
    </div>
    `
